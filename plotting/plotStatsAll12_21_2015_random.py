...
# 50 trials per
# 0% bias level, random action selection
...
import statsFiles12_21_2015_random
import json
import os
...
outFile = exeDir+'/rmStatesAll12_21_2015_random.txt'
...
if(True):
    files = statsFiles12_21_2015_random.files
