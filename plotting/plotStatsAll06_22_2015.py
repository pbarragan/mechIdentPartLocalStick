# this is for the 6/22/2015 experiments
# 50 trials per
# 80% bias level, random action selection
...
print exeDir
dirName = '/home/barragan/dataPostGrad/2015_06_22/'

outFile = exeDir+'/rmStatesAll06_22_2015.txt'
...
if(True):
    files = statsFiles06_22_2015.files
