# this is for the 12/21/2015 experiments
# 50 trials per
# 0% bias level, simple action selection
...
import statsFiles12_21_2015_simple
import json
import os
...
print exeDir
dirName = '/home/barragan/dataPostGrad/2015_12_21_simple/'

outFile = exeDir+'/rmStatesAll12_21_2015_simple.txt'
...
if(True):
    files = statsFiles12_21_2015_simple.files
